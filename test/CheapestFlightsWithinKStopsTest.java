	...
	public void test() {
		...
		result = c.findCheapestPrice(17,
				new int[][] {{0, 12, 28}, {5, 6, 39}, {8, 6, 59}, {13, 15, 7}, {13, 12, 38}, {10, 12, 35}, {15, 3, 23},
						...
						{5, 7, 77}, {4, 10, 18}, {7, 2, 11}, {9, 5, 41}}, 13, 4, 13);
		Assert.assertThat(result, CoreMatchers.equalTo(47));

		result = c.findCheapestPrice(4, new int[][] {{0, 1, 1}, {0, 2, 5}, {1, 2, 1}, {2, 3, 1}}, 0, 3, 1);
		Assert.assertThat(result, CoreMatchers.equalTo(6));

		result = c.findCheapestPrice(3, new int[][] {{0, 1, 100}, {1, 2, 100}, {0, 2, 500}}, 0, 2, 1);
		Assert.assertThat(result, CoreMatchers.equalTo(200));

		result = c.findCheapestPrice(10,
				new int[][] {{3, 4, 4}, {2, 5, 6}, {4, 7, 10}, {9, 6, 5}, {7, 4, 4}, {6, 2, 10}, {6, 8, 6}, {7, 9, 4}, {1, 5, 4},
		...
		result = c.findCheapestPrice(4, new int[][] {{0, 1, 1}, {0, 2, 2}, {0, 3, 3}}, 1, 3, 5);
